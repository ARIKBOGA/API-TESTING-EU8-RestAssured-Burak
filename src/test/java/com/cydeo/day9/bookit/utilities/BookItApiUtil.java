...
public class BookItApiUtil {
    ...
    public static void deleteStudent(String studentEmail, String studentPassword) {
        ...
        String studentToken = generateToken(studentEmail, studentPassword);
        ...
        String teacherToken = generateToken(Environment.TEACHER_EMAIL, Environment.TEACHER_PASSWORD);
        given().
